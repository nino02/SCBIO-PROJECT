...
class AvatarWindow(QWidget):
    ...
    def ventana_dashboard(self):
        ...
        # Verificar si hay datos para representar
        ...
        if filtered_sizes:
            ...
            # Crear un QLabel para mostrar el mensaje "No hay datos"
            canvas = QLabel("No hay datos", self)
            canvas.setAlignment(Qt.AlignCenter)
            canvas.setStyleSheet("font-size: 18pt;")
    ...
    def eyedetection(self):
        ...
        # Crear un nuevo diccionario excluyendo la clave 'left eye'
        filtered_dict = {key: value for key, value in out_dic.items() if key != 'left eye'}
        print(filtered_dict)
